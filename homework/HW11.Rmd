...
Education levels may vary in survey samples, particularly in surveys regarding voting, because often times people with higher levels of education are more likely to vote than those with lower education levels. For this reason, people who are college-educated may be overrepresented.
...
An overwhelming majority of voters, regardless of their education level, said they intend to vote
...
The percentages didn't change all that much, but the education group that changed the most is high school or less. They now have a lower percentage of "yes" and higher percentages of "no" and "unsure."

2. Why might the weighted results be considered more accurate than the unweighted results?

Weighted results are more accurate than unweighted because it targets one specific population of voters who might not often respond to surveys like these. This way, the population of that group is more accurately represented.
...
The visualization makes it only slightly easier to see the difference between weighted and unweighted results because the results are simply similar, despite the differences in calculation methods
...
Weighted or unweighted, based on this data, it is more likely for people with higher levels of education to say that, yes, they will be voting. Education level is not a direct indicator of whether or not someone will be voting, but it is showing that over 90% of the respondents who are college-educated said yes.

When weighted, though, the results vary slightly. The biggest change was between the weighted and unweighted results of those with high school or less levels of education, and college level education barely budged (though it did go up, slightly). This could be an indicator that college educated people are more likely to answer a survey asking about voting, especially if they are the group who is most likely to vote anyway. It also shows that they are represented accurately in the sample data But this could also tell us some more information about the "high school or less" group because it shows that their responses actually weigh less because they may be overrepresented in this set of data.

What this all means for interpreting polls is that you should take note of whether the results are weighted or unweighted because it could change the numbers significantly. In this case the changes weren't all that drastic, but they can be every once in a while. It's important to keep in mind that weighted results are typically more accurate than unweighted.
...
1. Why is it important for journalists to understand survey weighting when reporting on polls?
    It is important to understand because it could account for biases of survey respondents as well as of pollsters, which is something that journalists always try to avoid, or at least account for. 

2. How might the differences between weighted and unweighted results affect how you would report on this data?
    For this specific data, I don't think it'll change how I report the data all that much because there is not much of a difference between the weighted and unweighted results. I would specify which one I'm using, though, and explain my reasoning for why.
...
3. What additional information would you want to know about how the weights were calculated before using this data in a news story?
    I would want to know the methodology behind collecting the data as well as the specific calculations just to make sure that there are no biases present in the collection and calculation process.
