...
They seem to have gone way down overall, but there are certain periods where the number of car thefts goes up and spikes.
...
The 95% confidence interval shows that the mean could be anywhere between approximately 420 to just above 500 car thefts. Confidence intervals describe the probability of how accurate you are with this calculation.
The figures that reflect the number of car thefts in a typical month are the pinpoints on the graph that fall within the red confidence interval marker. Those points are closest to the calculated average/mean.

HEADLINE: Car thefts lower than they have been in the past two years, but have the potential to increase again.
...
PUT ANSWERS HERE
I think the null hypothesis can be rejected because even though the two charts look very similar because the means and confidence intervals are different. Although, according to the p-value, the difference between the two periods is not statistically significant.

I feel like I might not revise my headline, but I would tell my editor that it is hard to tell just how different the first and second half of the data are, and that the first chart makes this difference more clear. The editor would probably ask me to explain further, and to do so in a way that can be understood by your average audience.
