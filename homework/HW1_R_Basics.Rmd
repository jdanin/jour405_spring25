...
I had to look up how to find the square root of 16 because I don't recall seeing that code before. I also did not know how to call up tidyverse. I tried installing it first before looking it up in the library, but now I can't call it up in the library (I'm not even sure if it's installed). I'm not sure what that message under that task means.

Update: it seems that the problem may have been just that I put quotation marks in when I didn't need to. The message I referred to is in the console.
