...
```
group by doesn't work unless you follow it up with summarize (but don't need group by if only summarize)
...
Maryland is within the 95th percentile, which means they produced more aces than 95% of the teams. This is a much bettter thing to write in a story than saying "Maryland was ranked number 17."
