...
```
** calculations usually use mutate or summarize
you want a calculation that ppl can wrap their minds around - ppl like 100s, 10,000
...
The years with the highest crime rates were primarily in the 1990s, and the years with the lowest rates are the most recent years, the 2010s and 2020s. Based on what I know about history, this pattern does match my expectations. Obviously I did not live through the '90s, but I have heard that that was typically a more violent time, and I have lived through the the most recent years and haven't noticed as much crime (although I'm privileged enough to live in such areas that don't experience much violent crime). I also want to compare it to policy changes throughout history to see if that changed anything.
