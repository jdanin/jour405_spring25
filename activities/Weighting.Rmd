...
1. What is the range of weights in this dataset?
    0.2298 (min) to 3.0386 (max)

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?
    The person with the higher weight is someone who is harder to find, such as a young person voting for the first time, and the person with the lower weight is someone who is easier to find, such as an older voter who has voted more than once.

3. Why might some respondents be weighted more heavily than others?
    Some respondents might be weighted more heavily because their responses might be more important to the data because they occur less frequently/are harder to find.
...
1. Which voter category shows the biggest difference between weighted and unweighted results?
    the rarely/never category usually has the biggest difference between weighted and unweighted results.

2. How might these differences affect reporting on likely voter turnout?
    It could make reporting on likely voter turnout finicky, and it would definitely be important to specify the methodology in the article just in case it affects how the data is perceived.
...
3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample?
    These differences exist because the weighting data will change the numerical outcome of the data. This tells us who is under or over represented by emphasizing that the data that needs more weight will be the data that is likely harder to find/quantify.
