...
ANSWER HERE
I would draw the line for the higher average at around 16 or 17 calls on the y-axis and the low average around 5 calls on the y-axis. The pattern seems relatively stable, but it does sort of go down the later in time it is.
...
ANSWER HERE
Compared to my response in task 3, the high and low call counts are a bit less extreme than what I had suggested. It seems like a good place for a line to be drawn would be at around 11 call counts, and the low around 7, but there are a few unusual days that are much lower than the low and much higher than the high. I think my initial choice for the line placement was reasonable, though.
...
ANSWER HERE
The day that has the highest call volume of drug overdoses is October 4, 2022, and the number of calls was much higher than the average, and even higher than those days that are marked as "unusually high."
...
ANSWER HERE
I think a potential angle for reporting this story could include the seasonal fluctuations, as there could be a lot of possible reasons why warmer months see more calls on average than colder months.
The next steps I would take would be to run a few more tests that examine different factors that affect the number of calls. Some of those factors include political or social events, location, school times, etc.
I would tell an editor about the difference between the unusually high days and the highest day (10/4/2022) as well as the difference between the unusually low and the lowest days.
